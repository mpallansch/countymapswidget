(function() {
  ...
  ***************************************/
  ...
  Datamap.prototype.draw = function() {
    ...
    } else if ( options.geographyConfig.data ) {
      self.customTopo = options.geographyConfig.data;
      draw( options.geographyConfig.data );
    } else {
...
;
  ...
  ***************************************/
  ...
  Datamap.prototype.updatePopup = function (element, d, options) {
    var self = this;
    var svgWidth = self.svg.node().clientWidth;
    var svgHeight = self.svg.node().clientHeight;
